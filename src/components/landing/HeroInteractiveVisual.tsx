...
export function HeroInteractiveVisual() {
  ...
  return (
    <div className="relative">
      ...
      <div
        ref={cardRef}
        className="group relative animate-float-gentle [perspective:1200px]"
      >
        <div
          ref={glowRef}
        ...
        <div
          ref={visualRef}
          className="relative h-[380px] w-[380px] [transform:translate3d(0,0,0)] will-change-transform md:h-[460px] md:w-[460px]"
        ...
        >
          <Image
            ...
            className="h-full w-full object-contain drop-shadow-[0_22px_24px_rgba(27,19,50,0.22)]"
          />
        </div>
      </div>
    </div>
